...
<body>
  ...
  <div class="row align-items-start" style="margin-top: 100px;">
    <div class="col">
      <img class="cartinca" src="/img/Торт услуга 2.jpg">
    </div>
    <div class="col text">
      <h2><b>Ягодный торт</b></h2>
      <p class="opisanie"> 
      <div class="container">
  <div class="row">
...
Для начинки:Любые ягоды – 350-400 гТворог жирностью 9% – 400  г Сливки<br> жирностью 33% – 100 гСахарная пудра – 150 г</p>
  <!-- КНОПКИ -->

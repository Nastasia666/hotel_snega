...
<body>
  ...
  <div class="row align-items-start" style="margin-top: 100px;">
    <div class="col">
      <img class="cartinca" src="/img/Шарики фигурные.jpg">
    </div>
    <div class="col text">
      <h2><b>Фигурные шарики</b></h2>
      <p class="opisanie"> 
      <div class="container">
  <div class="row">
    <div class="col order-last competextt">
    Воздушные шары торговой марки "BOOMZEE" арт.BLS-25 помогут вам создать праздничную атмосферу, сопровождаемую весельем и радостью. Из шаров вы можете создать яркие декорации для оформления интерьера, которые поднимут настроение вам и вашим друзьям независимо от торжества - свадьба, день рождения.
    </div>
...
<div class="container text-center">
  <div class="row align-items-center">
    ...
    <div class="container">
  <div class="row block">
    <div class="col-6 col-sm-4 name">Бренд:</div>
    <div class="col-6 col-sm-4 explanation">"BOOMZEE"</div>

    <!-- Заставит следующие колонки переходить на новую строку в контрольной точке md и выше -->
    <div class="w-100 d-none d-md-block"></div>

    <div class="col-6 col-sm-4 name">Страна:</div>
    <div class="col-6 col-sm-4 explanation">Китай</div>

    <div class="w-100 d-none d-md-block"></div>

    <div class="col-6 col-sm-4 name">Размер, в см:</div>
    <div class="col-6 col-sm-4 explanation">50</div>
  </div>
</div>
    </div>
    <div class="col">
    ...
    <div class="container">
  <div class="row">
    <div class="col-6 col-sm-4 name">Материал шара:</div>
    <div class="col-6 col-sm-4 explanation">Латекс, фальгированные</div>

    <!-- Заставит следующие колонки переходить на новую строку в контрольной точке md и выше -->
    <div class="w-100 d-none d-md-block"></div>

    <div class="col-6 col-sm-4 name">Коллекция:</div>
    <div class="col-6 col-sm-4 explanation">Фигурные</div>

    <div class="w-100 d-none d-md-block"></div>

    <div class="col-6 col-sm-4 name bloc">Асортименте:</div>

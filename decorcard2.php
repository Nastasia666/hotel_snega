...
<body>
  ...
  <div class="row align-items-start" style="margin-top: 100px;">
    <div class="col">
      <img class="cartinca" src="/img/Шарики прозрачные.jpg">
    </div>
    <div class="col text">
      <h2><b>Прозрачные шарики</b></h2>
      <p class="opisanie"> 
      <div class="container">
  <div class="row">
...
<div class="container text-center">
  ...
  <div class="row block">
    ...
    <div class="col-6 col-sm-4 explanation">38</div>
  </div>
</div>
    </div>
    <div class="col">
  ...
  <div class="row">
    ...
    <div class="col-6 col-sm-4 explanation">Латекс</div>

    <!-- Заставит следующие колонки переходить на новую строку в контрольной точке md и выше -->
    <div class="w-100 d-none d-md-block"></div>

    <div class="col-6 col-sm-4 name">Коллекция:</div>
    <div class="col-6 col-sm-4 explanation">С наполнением</div>

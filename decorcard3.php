...
<body>
  ...
  <div class="row align-items-start" style="margin-top: 100px;">
    <div class="col">
      <img class="cartinca" src="/img/Шарики светящиеся.jpg">
    </div>
    <div class="col text">
      <h2><b>Светящиеся шарики</b></h2>
      <p class="opisanie"> 
      <div class="container">
  <div class="row">
...
<div class="container text-center">
  ...
  <div class="row block">
    ...
    <div class="col-6 col-sm-4 explanation">30</div>
  </div>
</div>
    </div>
    <div class="col">
  ...
  <div class="row">
    ...
    <div class="col-6 col-sm-4 explanation">Светодеодные</div>

...
<body>
  ...
  <div class="row align-items-start" style="margin-top: 100px;">
    <div class="col">
      <img class="cartinca" src="/img/Колонки 2.jpg">
    </div>
    <div class="col text">
      <h2><b>Колонки Magnat Shadow 209 Set 5.1.</b></h2>
      <p class="opisanie"> 
      <div class="container">
  <div class="row">
    <div class="col order-last competextt">
    Колонки Magnat Shadow 209 Set 5.1 установка напольная/полочная, а также тип пассивная/активная
    </div>
